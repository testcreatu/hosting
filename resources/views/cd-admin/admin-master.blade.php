...
<head>
    ...
    <link href="{{url('public/cd-admin/assets/layouts/layout4/css/layout.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/cd-admin/assets/layouts/layout4/css/themes/default.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
    <link href="{{url('public/cd-admin/assets/layouts/layout4/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{url('public/cd-admin/assets/layouts/layout4/scripts/layout.min.js')}}" type="text/javascript"></script>
<script src="{{url('public/cd-admin/assets/layouts/layout4/scripts/demo.min.js')}}" type="text/javascript"></script>
